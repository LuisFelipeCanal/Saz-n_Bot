...
if prompt := st.chat_input("¿Qué te gustaría pedir?"):
    ...
    chat_completion = client.chat.completions.create(
        messages=[
            ...
            {"role": "user", "content": f"Extrae la cantidad y el plato de la siguiente solicitud: '{prompt}'.Limitate a solo devolver la cantidad y el plato sin un caracter adicional de la solicitud."},
        ],
